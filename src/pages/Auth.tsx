...
import { Loader2, Eye, EyeOff, Sparkles, Phone, ArrowLeft } from 'lucide-react';
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <Button
                          ...
                          className="w-full rounded-full h-12 border-border/50 hover:bg-muted/50 transition-all flex items-center gap-3"
                        >
                          {googleLoading ? (
                            <Loader2 className="h-4 w-4 animate-spin" />
                          ) : (
